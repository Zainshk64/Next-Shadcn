...
import { Code2, Github, MonitorSmartphone } from "lucide-react";

export function AnimatedModalDemo() {
  const images = [
    "https://react-portfolio-alpha-ashen-11.vercel.app/assets/educate-Ba_McY0I.png",
    "https://react-portfolio-alpha-ashen-11.vercel.app/assets/hotel-CNgcdOzP.png",
    "https://react-portfolio-alpha-ashen-11.vercel.app/assets/bakery-D4mxoebV.png",
    "https://react-portfolio-alpha-ashen-11.vercel.app/assets/virtual-DZQi-siW.png",
    "https://react-portfolio-alpha-ashen-11.vercel.app/assets/nextport-C598xeGB.png",
  ];
  return (
    <div className="py-5  flex items-center justify-center">
      <Modal>
        <ModalTrigger
          className="bg-black cursor-pointer dark:bg-white dark:text-black text-white flex justify-center group/modal-btn">
          <span
          ...
          <div
            ...
            <Code2 className="text-white dark:text-black"/>
          </div>
        </ModalTrigger>
        <ModalBody>
          <ModalContent>
            ...
            <div
              ...
              <div className="flex  items-center justify-center">
                <Code2 className="mr-1 text-neutral-700 dark:text-neutral-300 h-4 w-4" />
